...
const commands = [
  ...
  {
    cmd: "/dictionary action:add",
    title: "辞書追加",
    usage: "/dictionary action:add key:単語 value:よみかた",
    desc: "指定した単語の読み方をカスタマイズできます。サーバーごとに登録可能です。",
    example: "/dictionary action:add key:甲斐田 value:かいだ",
  },
  {
    cmd: "/dictionary action:list",
    title: "辞書一覧",
    usage: "/dictionary action:list",
    desc: "サーバーに登録されている辞書の一覧を表示します。",
    example: "/dictionary action:list",
  },
  {
    cmd: "/dictionary action:remove",
    title: "辞書削除",
    usage: "/dictionary action:remove key:単語",
    desc: "指定した単語の読み方を削除します。サーバーごとに登録された辞書から削除されます。",
    example: "/dictionary action:remove key:甲斐田",
  },
  {
    cmd: "/dictionary action:search",
    title: "辞書検索",
    usage: "/dictionary action:search key:単語",
    desc: "指定した単語の読み方を検索します。サーバーごとに登録された辞書から検索されます。",
    example: "/dictionary action:search key:甲斐田",
  },
  {
    cmd: "/voice",
    title: "音声選択",
